clear
load('Data_Pedalling_150W_Baseline_Day1.mat')
...
for k=1:size(Target_Subject_Complete,2)
    ...
    for m=2:4:size(Target_Subject_Complete,2)
        ...
        for n=1:10
            ...
            save(['Robustness\Pedalling\Data_Pedalling_150W_Baseline_Day1_P' num2str(k),'_N', num2str(m),'_S', num2str(n),'.mat'],'Feature','Feature_EMG_Label','Target_Subject')
